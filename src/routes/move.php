<?php
$app->post('/api/Dropbox/move', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken', 'fromPath', 'toPath']);
    ...
    $query_str = $settings['api_url'] . "2/files/move";
    $body = array();
