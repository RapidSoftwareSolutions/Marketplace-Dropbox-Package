<?php
$app->post('/api/Dropbox/moveBatch', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken', 'entries']);
    ...
    $query_str = $settings['api_url'] . "2/files/move_batch";
    $body = array();
