<?php
$app->post('/api/Dropbox/getUserMountableFolders', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . "2/sharing/list_mountable_folders";
    $body = array();
    ...
    if (isset($post_data['args']['actionsList']) && count($post_data['args']['actionsList']) > 0) {
