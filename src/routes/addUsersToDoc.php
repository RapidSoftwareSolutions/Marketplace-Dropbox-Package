<?php
$app->post('/api/Dropbox/addUsersToDoc', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['accessToken', 'documentId', 'membersList']);
    ...
    $query_str = $settings['api_url'] . "2/paper/docs/users/add";
    $body = array();
